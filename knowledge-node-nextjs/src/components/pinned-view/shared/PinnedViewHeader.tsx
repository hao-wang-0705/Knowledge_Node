...
interface PinnedViewHeaderProps {
  tag: TagTemplate;
  onBack: () => void;
  children?: React.ReactNode; // 用于放置 ViewSwitcher 等额外控件
}

export function PinnedViewHeader({ tag, onBack, children }: PinnedViewHeaderProps) {
  return (
...
export default PinnedViewHeader;
